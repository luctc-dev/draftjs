...
const defaultImage = 'https://p.bigstockphoto.com/GeFvQkBbSLaMdpKXF1Zv_bigstock-Aerial-View-Of-Blue-Lakes-And--227291596.jpg';
    ...
    if (contentBlock.getType() === 'atomic') {
      return {
          ...
          component: (props: any) => {
            ...
            return (
              <img src={src} alt={src} className="draftImg"/>
            )
          },
          editable: false,
      };
        ...
        <Row gutter={30}>
          <Col span={24}> 
            <Input 
              ...
              size="large" type="text" placeholder="Enter the url image" />
          </Col>
          <Col span={6}>
            <Button
              style={{ marginTop: '1rem' }}
              onClick={handleInsertImage}
              size="large" type="primary">Insert Image</Button>
          </Col>
        </Row>
